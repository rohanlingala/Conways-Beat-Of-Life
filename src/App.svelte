<script>
  ...
  let beat = 0;
  let isPlaying = false;
  let snare = new Tone.Player("./src/assets/Speed Racer Snare.wav").toDestination()
  ...
  // Dorian scale notes
  const scaleOfNotes = [
   "./src/assets/Alien kick.wav", "./src/assets/Speed Racer Snare.wav", "./src/assets/CD Rip.wav",
   "./src/assets/GimmeSynth Bass.wav", "./src/assets/Glass E.wav","./src/assets/Flange Open Hat.wav",
